    ...
    <div className="flex h-screen w-full items-center justify-center bg-gray-50 p-4">
      <form className="flex w-full max-w-sm flex-col gap-5 rounded-2xl bg-white p-8 shadow-xl">
        <div className="text-center">
          ...
          <p className="text-sm text-gray-500">Hoster Login</p>
        </div>
        ...
        <div className="mt-2 flex flex-col gap-3">
          ...
          <div className="relative flex items-center justify-center py-2">
            ...
            <span className="absolute bg-white px-2 text-xs text-gray-400 font-medium uppercase">Or</span>
          </div>
